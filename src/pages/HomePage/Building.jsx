                  ...
                  <div className="tickets">
                    <div>
                      ...
                      <div className="u-alone">
                        <div className="presence">Web Development</div>
                        <div className="presence2">UI/UX Design</div>
                        <div className="presence3">Branding </div>
                      </div>
                      <div>
                ...
                <div className="lplp">
                  <div className="ynl">
                    ...
                    <div className="memind">
                      Start a ride hailing business, or Logistics startup today.
                      Let's build your product from start to finish, go to
                      market in 8 weeks.
                    </div>
                    <div>
                      <div className="u-alone">
                      ...
                      <div>
                        <button className="sbbb">Start Building</button>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="lplp">
                  <div className="ynl">
                    ...
                    <div>
                      ...
                      <div>
                        <button className="sbbb2 mb-4">Start Building</button>
                      </div>
                    </div>
                  </div>
                </div>
